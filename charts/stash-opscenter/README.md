...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2024.8.27
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2024.8.27
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2024.8.27 --values values.yaml
```
