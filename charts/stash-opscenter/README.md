...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2023.05.31
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.05.31
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.05.31 --values values.yaml
```
