...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2024.9.30
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2024.9.30 --values values.yaml
```
