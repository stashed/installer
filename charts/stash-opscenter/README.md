...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2023.04.30
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.04.30
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.04.30 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.04.30 --values values.yaml
```
