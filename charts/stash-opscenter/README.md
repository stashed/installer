...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2022.05.12
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.05.12
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.05.12 --values values.yaml
```
