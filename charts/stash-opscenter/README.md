...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2022.06.27
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.27
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.27 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.27 --values values.yaml
```
