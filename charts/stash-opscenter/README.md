...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2023.03.20
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.03.20
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.03.20 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.03.20 --values values.yaml
```
