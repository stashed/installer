...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2023.10.9
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.10.9
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.10.9 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.10.9 --values values.yaml
```
