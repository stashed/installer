...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2023.08.18
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.08.18
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2023.08.18 --values values.yaml
```
