...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2022.06.21
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.21
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.21 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.06.21 --values values.yaml
```
