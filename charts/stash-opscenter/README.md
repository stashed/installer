...
$ helm repo update
$ helm search repo appscode/stash-opscenter --version=v2022.12.11
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.12.11
```
...
```bash
$ helm upgrade -i stash-opscenter appscode/stash-opscenter -n kubeops --create-namespace --version=v2022.12.11 --values values.yaml
```
