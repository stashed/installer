...
$ helm repo update
$ helm search repo appscode/stash --version=v2022.05.12
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.12
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.12 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.12 --values values.yaml
```
