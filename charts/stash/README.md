...
$ helm repo update
$ helm search repo appscode/stash --version=v2022.06.21
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.21
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.21 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.21 --values values.yaml
```
