...
$ helm repo update
$ helm search repo appscode/stash --version=v2024.4.8
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.4.8
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.4.8 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.4.8 --values values.yaml
```
