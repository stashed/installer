...
$ helm repo update
$ helm search repo appscode/stash --version=v2023.03.20
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.03.20
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.03.20 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.03.20 --values values.yaml
```
