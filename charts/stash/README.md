...
$ helm repo update
$ helm search repo appscode/stash --version=v2023.01.05
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.01.05
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.01.05 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.01.05 --values values.yaml
```
