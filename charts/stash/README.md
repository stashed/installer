...
$ helm repo update
$ helm search repo appscode/stash --version=v2022.07.09
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.07.09
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.07.09 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.07.09 --values values.yaml
```
