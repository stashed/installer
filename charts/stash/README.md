...
$ helm repo update
$ helm search repo appscode/stash --version=v2024.12.18
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.12.18
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.12.18 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.12.18 --values values.yaml
```
