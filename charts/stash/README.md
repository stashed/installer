...
$ helm repo update
$ helm search repo appscode/stash --version=v2025.6.30
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2025.6.30
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2025.6.30 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2025.6.30 --values values.yaml
```
