...
$ helm repo update
$ helm search repo appscode/stash --version=v2023.04.30
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.04.30
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.04.30 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.04.30 --values values.yaml
```
