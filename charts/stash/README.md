...
$ helm repo update
$ helm search repo appscode/stash --version=v2023.02.28
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.02.28
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.02.28 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2023.02.28 --values values.yaml
```
