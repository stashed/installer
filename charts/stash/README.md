...
$ helm repo update
$ helm search repo appscode/stash --version=v2024.8.27
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.8.27
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.8.27 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.8.27 --values values.yaml
```
