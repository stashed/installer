...
$ helm repo update
$ helm search repo appscode/stash --version=v2024.2.13
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.2.13
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.2.13 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2024.2.13 --values values.yaml
```
