...
$ helm repo update
$ helm search repo appscode/stash --version=v2022.06.27
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.27
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.27 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.06.27 --values values.yaml
```
