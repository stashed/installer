...
$ helm repo update
$ helm search repo appscode/stash --version=v2022.05.18
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.18
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.18 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i stash appscode/stash -n stash --create-namespace --version=v2022.05.18 --values values.yaml
```
