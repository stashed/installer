...
| security.podSecurityPolicies          | PSP names passed to operator <br> Example: <br> `helm install appscode/stash \` <br> `--set podSecurityPolicies[0]=abc \` <br> `--set podSecurityPolicies[1]=xyz`                                                                                 | `["app-stash"]`                                                       |
| platform.openshift                    | Set true, if installed in OpenShift                                                                                                                                                                                                               | `false`                                                               |
| nfsHelper.cpu                         | CPU resource for each NFS helper deployment                                                                                                                                                                                                       | `100m`                                                                |
| nfsHelper.memory                      | Memory for each NFS helper deployment                                                                                                                                                                                                             | `128Mi`                                                               |
| nfsHelper.runAsUser                   | Run the NFS helper deployments with this UID.                                                                                                                                                                                                     | `2000`                                                                |
| nfsHelper.privileged                  | Run the NFS helper deployments in privileged mode                                                                                                                                                                                                 | `false`                                                               |
