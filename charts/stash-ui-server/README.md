...
$ helm repo update
$ helm search repo appscode/stash-ui-server --version=v0.6.0
$ helm upgrade -i stash-ui-server appscode/stash-ui-server -n kubeops --create-namespace --version=v0.6.0
```
...
```bash
$ helm upgrade -i stash-ui-server appscode/stash-ui-server -n kubeops --create-namespace --version=v0.6.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i stash-ui-server appscode/stash-ui-server -n kubeops --create-namespace --version=v0.6.0 --values values.yaml
```
