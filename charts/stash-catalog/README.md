...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2024.2.9-rc.0
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.9-rc.0
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.9-rc.0 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.9-rc.0 --values values.yaml
```
