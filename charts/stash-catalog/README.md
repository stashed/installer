...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2024.2.13
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.13
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.13 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2024.2.13 --values values.yaml
```
