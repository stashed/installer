...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2025.7.31
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.7.31 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.7.31 --values values.yaml
```
