...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2022.09.29
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.09.29
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.09.29 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.09.29 --values values.yaml
```
