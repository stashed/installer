...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2022.07.09
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.07.09
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.07.09 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.07.09 --values values.yaml
```
