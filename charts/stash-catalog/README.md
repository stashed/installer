...
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.02.22
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.02.22 --set image.registry=stashed
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2022.02.22 --values values.yaml
```
