...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2025.10.17
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.10.17
```
...
| mariadb.backup.args                     | Arguments to pass to `mariadbdump` command during backup process                                                                       | <code>"--all-databases --ignore-database=mysql"</code> |
...
| mysql.backup.args                       | Arguments to pass to `mysqldump` command during backup process                                                                         | <code>"--all-databases"</code>                         |
...
| perconaxtradb.backup.args               | Arguments to pass to `mysqldump` command during backup process                                                                         | <code>"--all-databases"</code>                         |
...
| redis.backup.args                       | Arguments to pass to `redis-dump` command during backup process                                                                        | <code>""</code>                                        |
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.10.17 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n stash --create-namespace --version=v2025.10.17 --values values.yaml
```
