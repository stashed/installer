...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2023.05.31
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2023.05.31
```
