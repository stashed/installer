...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2024.2.9-rc.0
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2024.2.9-rc.0
```
