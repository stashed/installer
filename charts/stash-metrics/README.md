...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2025.7.31
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2025.7.31
```
