...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2024.8.27
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2024.8.27
```
