...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2022.06.21
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2022.06.21
```
