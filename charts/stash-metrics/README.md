...
$ helm repo update
$ helm search repo appscode/stash-metrics --version=v2023.03.20
$ helm upgrade -i stash-metrics appscode/stash-metrics -n stash --create-namespace --version=v2023.03.20
```
