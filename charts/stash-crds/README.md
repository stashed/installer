...
$ helm repo update
$ helm search repo appscode/stash-crds --version=v2025.10.17
$ helm upgrade -i stash-crds appscode/stash-crds -n stash --create-namespace --version=v2025.10.17
```
...
```bash
$ helm upgrade -i stash-crds appscode/stash-crds -n stash --create-namespace --version=v2025.10.17 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i stash-crds appscode/stash-crds -n stash --create-namespace --version=v2025.10.17 --values values.yaml
```
