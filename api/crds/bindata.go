...
func installerStashAppscodeCom_stashoperatorsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "installer.stash.appscode.com_stashoperators.yaml", size: 49367, mode: os.FileMode(420), modTime: time.Unix(1573722179, 0)}
