...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NfsHelper) DeepCopyInto(out *NfsHelper) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NfsHelper.
func (in *NfsHelper) DeepCopy() *NfsHelper {
	if in == nil {
		return nil
	}
	out := new(NfsHelper)
