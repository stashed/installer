...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManifestBackupSpec) DeepCopyInto(out *ManifestBackupSpec) {
	*out = *in
	out.Backup = in.Backup
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManifestBackupSpec.
func (in *ManifestBackupSpec) DeepCopy() *ManifestBackupSpec {
	if in == nil {
		return nil
	}
	out := new(ManifestBackupSpec)
	in.DeepCopyInto(out)
	return out
}
