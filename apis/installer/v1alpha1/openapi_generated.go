...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"stash.appscode.dev/installer/apis/installer/v1alpha1.StashOperatorChartValues": schema_installer_apis_installer_v1alpha1_StashOperatorChartValues(ref),
...
func schema_installer_apis_installer_v1alpha1_StashOperatorChartValues(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"replicaCount", "operator", "pushgateway", "cleaner", "imagePullPolicy", "criticalAddon", "logLevel", "annotations", "nodeSelector", "serviceAccount", "apiserver", "enableAnalytics", "monitoring", "additionalPodSecurityPolicies", "platform"},
			},
		},
		Dependencies: []string{
...
func schema_installer_apis_installer_v1alpha1_StashOperatorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"values": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/installer/apis/installer/v1alpha1.StashOperatorChartValues"),
						},
					},
				},
		...
		Dependencies: []string{
			"stash.appscode.dev/installer/apis/installer/v1alpha1.StashOperatorChartValues"},
	}
}
