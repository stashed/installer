...
func generateSwaggerJson() {
	...
	apispec, err := openapi.RenderOpenAPISpec(openapi.Config{
		...
		Resources: []openapi.TypeInfo{
			{api.SchemeGroupVersion, api.ResourceStashOperators, api.ResourceKindStashOperator, false},
		},
	})
	if err != nil {
		glog.Fatal(err)
	...
	filename := gort.GOPath() + "/src/stash.appscode.dev/installer/api/openapi-spec/swagger.json"
